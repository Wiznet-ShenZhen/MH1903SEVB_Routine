...
int main(void)
{
	...
	//10Mbps
	phyconf=IINCHIP_READ(PHYCFGR);						//¶ÁPHYÅäÖÃ¼Ä´æÆ÷µÄÖµ
	printf("phy1=0x%x\r\n",phyconf);
	
	printf("phy s/w reset\r\n");
	IINCHIP_WRITE(PHYCFGR,0x7F);							//Èí¸´Î»W5500£¨Èí¸´Î»ºó²ÅÄÜÅäÖÃ¼Ä´æÆ÷£©
	IINCHIP_WRITE(PHYCFGR,0xCF);							//ÅäÖÃPHY¼Ä´æÆ÷Îª10MÈ«Ë«¹¤Ä£Ê½ 


	//100Mbps
//	IINCHIP_WRITE(PHYCFGR,0x7F);							//Èí¸´Î»W5500£¨Èí¸´Î»ºó²ÅÄÜÅäÖÃ¼Ä´æÆ÷£©
//	IINCHIP_WRITE(PHYCFGR,0xDF);							//ÅäÖÃPHY¼Ä´æÆ÷Îª100MÈ«Ë«¹¤Ä£Ê½


//  10/100Mbps
//	IINCHIP_WRITE(PHYCFGR,0x7F);							//Èí¸´Î»W5500£¨Èí¸´Î»ºó²ÅÄÜÅäÖÃ¼Ä´æÆ÷£
//	IINCHIP_WRITE(PHYCFGR,0xBF);							//ÅäÖÃPHY¼Ä´æÆ÷Îª10/100MÈ«Ë«¹¤Ä£Ê½
...
//	IINCHIP_WRITE(PHYCFGR,0x7f);							//Èí¸´Î»
//	IINCHIP_WRITE(PHYCFGR,0xF7);							//Èí¸´Î»ºóÖØÐÂÅäÖÃPHY¼Ä´æÆ÷ÎªµôµçÄ£Ê½
//	Delay_ms(5000);
//	Delay_ms(5000);
//	Delay_ms(5000);
...
//	Reset_W5500();														//µôµçÄ£Ê½±ØÐëÍ¨¹ýÓ²¼þ¸´Î»»½ÐÑ
//	set_network();														//Ó²¼þ¸´Î»ºóÐèÒªÖØÐÂÅäÖÃW5500
